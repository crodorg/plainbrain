...
orphan candidates. Fold its findings into the report, then do the semantic passes below.
...
- Propose concrete fixes. Apply the ones the user approves (or, in headless mode, apply
